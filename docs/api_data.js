define({ api: [
  ...
  },
  {
    "type": "get",
    "url": "/orders",
    "title": "Order: get order",
    "name": "getOrders",
    "group": "Order",
    "examples": [
      {
        "title": "Example usage:",
        "content": "/orders //will return all orders",
        "type": "json"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "/orders/551a559ec3ca9c5c1aad9b0d",
        "type": "json"
      }
    ],
    "version": "0.0.0",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "_id",
            "description": "<p>Order id [Post parameter]</p> "
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "catalog_ids",
            "description": "<p>Catalog ids [Post parameter] // comma-separated string</p> "
          }
        ]
      }
    },
